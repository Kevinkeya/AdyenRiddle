 ...
 */
public class ExampleCheck3 extends AbstractCheck {

    public ExampleCheck3(int id) {
        super(id);
    }
    ...
    public boolean approveRecord(RiskSystemState state) {
        ...
        boolean isVisaDebit = record.getData("txvariantcode").equals("visadebit");
        int amount = Integer.parseInt(record.getData("amount"));

        return !(isVisaDebit && amount>15000);
    }
}
